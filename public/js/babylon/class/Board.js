...
export default class Board {
    ...
    constructor({playerId, playerName, flower}) {
        ...
        this.container = document.getElementById('wrapper-canvas');
        // renderer
        ...
        // mouse
        this.mouse = new THREE.Vector2(); // マウス五座標管理用ベクトル
        ...
        /** タイルストック @type {Object3D[]} */  this.stockTiles = [];
    ...
    resizeRenderer = () => {
        ...
        this.renderer.setSize(width, height, false); // 第3引数falseでCSSに合わせる
